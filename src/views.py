...
SITEMAP = {
    ...
    'schedule-friday.html': {'prio': '0.4', 'freq': 'weekly'},
    'schedule-saturday.html': {'prio': '0.4', 'freq': 'weekly'},
    'schedule-sunday.html': {'prio': '0.4', 'freq': 'weekly'},
    'pod-zastitou-prezidenta-slovenskej-republiky.html': {'prio': '0.5', 'freq': 'weekly'},
    'spy.html': {'prio': '0.75', 'freq': 'weekly'},
    'stats-web.html': {'prio': '0.5', 'freq': 'weekly'},
    'stats-slido.html': {'prio': '0.5', 'freq': 'weekly'},
...
@app.route('/<lang_code>/ba-10-meetup.html')
def ba_meetup_10():
    lang =  get_locale()
    LDJSON_EVENT = {
      "@context": "http://schema.org",
      "@type": "Event",
      "name": u"Desiaty Bratislavský Python Meetup",
      "startDate": "2016-05-03T18:00:00+01:00",
      "endDate" : "2016-05-03T21:00:00+01:00",
      "url": "https://pycon.sk/"+ lang +"/ba-10-meetup.html",
#      "sameAs": "https://www.facebook.com/events/110990379283146/",
      "location": {
        "@type": "Place",
        "sameAs": "https://progressbar.sk",
    ...
    return render_template('ba-10-meetup.html', **_get_template_variables(logo=LOGO_MEETUP_BA, li_meetup='active',
                                                                          ld_json=LDJSON_EVENT))

@app.route('/<lang_code>/ba-11-meetup.html')
def ba_meetup_11():
    lang =  get_locale()
    LDJSON_EVENT = {
      "@context": "http://schema.org",
      "@type": "Event",
      "name": u"Jedenásty Bratislavský Python Meetup",
      "startDate": "2016-06-07T18:30:00+01:00",
      "endDate" : "2016-06-07T20:00:00+01:00",
      "url": "https://pycon.sk/"+ lang +"/ba-11-meetup.html",
#      "sameAs": "https://www.facebook.com/events/110990379283146/",
      "location": {
        "@type": "Place",
        "sameAs": "https://progressbar.sk",
    ...
    return render_template('ba-11-meetup.html', **_get_template_variables(logo=LOGO_MEETUP_BA, li_meetup='active',
                                                                          ld_json=LDJSON_EVENT))


@app.route('/<lang_code>/ba-12-meetup.html')
def ba_meetup_12():
    lang =  get_locale()
    LDJSON_EVENT = {
      "@context": "http://schema.org",
      "@type": "Event",
      "name": u"Dvanásty Bratislavský Python Meetup",
      "startDate": "2016-07-12T18:30:00+01:00",
      "endDate" : "2016-07-12T20:00:00+01:00",
      "url": "https://pycon.sk/"+ lang +"/ba-12-meetup.html",
#      "sameAs": "https://www.facebook.com/events/110990379283146/",
      "location": {
        "@type": "Place",
        "sameAs": "https://progressbar.sk",
    ...
    return render_template('ba-12-meetup.html', **_get_template_variables(logo=LOGO_MEETUP_BA, li_meetup='active',
                                                                          ld_json=LDJSON_EVENT))



@app.route('/<lang_code>/ba-13-meetup.html')
def ba_meetup_13():
    lang =  get_locale()
    LDJSON_EVENT = {
      "@context": "http://schema.org",
      "@type": "Event",
      "name": u"Trinásty Bratislavský Python Meetup",
      "startDate": "2016-09-13T18:00:00+01:00",
      "endDate" : "2016-09-13T21:00:00+01:00",
      "url": "https://pycon.sk/"+ lang +"/ba-13-meetup.html",
      "sameAs": "https://www.facebook.com/events/489645064576958/",
      "location": {
        "@type": "Place",
        "sameAs": "https://progressbar.sk",
        "name": "Progressbar",
    ...
    return render_template('ba-13-meetup.html', **_get_template_variables(logo=LOGO_MEETUP_BA, li_meetup='active',
                                                                          ld_json=LDJSON_EVENT))


@app.route('/<lang_code>/ba-14-meetup.html')
def ba_meetup_14():
    lang =  get_locale()
    LDJSON_EVENT = {
      "@context": "http://schema.org",
      "@type": "Event",
      "name": u"Štrnásty Bratislavský Python Meetup",
      "startDate": "2016-10-04T18:00:00+01:00",
      "endDate" : "2016-10-04T21:00:00+01:00",
      "url": "https://pycon.sk/"+ lang +"/ba-14-meetup.html",
      "sameAs": "https://www.facebook.com/events/489645064576958/",
      "location": {
        "@type": "Place",
        "sameAs": "https://progressbar.sk",
    ...
    return render_template('ba-14-meetup.html', **_get_template_variables(logo=LOGO_MEETUP_BA, li_meetup='active',
                                                                          ld_json=LDJSON_EVENT))


@app.route('/<lang_code>/ba-15-meetup.html')
def ba_meetup_15():
    lang =  get_locale()
    LDJSON_EVENT = {
      "@context": "http://schema.org",
      "@type": "Event",
      "name": u"Päťnásty Bratislavský Python Meetup",
      "startDate": "2016-11-08T18:30:00+01:00",
      "endDate" : "2016-11-08T21:30:00+01:00",
      "url": "https://pycon.sk/"+ lang +"/ba-15-meetup.html",
      "sameAs": "https://www.facebook.com/events/1783963028520871/",
      "location": {
        "@type": "Place",
        "sameAs": "https://progressbar.sk",
        "name": "Progressbar",
    ...
    return render_template('ba-15-meetup.html', **_get_template_variables(logo=LOGO_MEETUP_BA, li_meetup='active',
                                                                          ld_json=LDJSON_EVENT))
